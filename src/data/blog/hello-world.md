...
This site is built with [Astro](https://astro.build) and deployed to GitHub Pages. The source is in a git repo. If GitHub Pages disappears tomorrow, I can deploy it anywhere in minutes.
...
I maintain [radosgw-admin](https://radosgw-admin.nycanshu.dev) — a Node.js SDK for the Ceph RADOS Gateway Admin Operations API. Some of my posts will reference it.
